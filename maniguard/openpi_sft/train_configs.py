...
# Real-teleop (DROID schema) warm start. pi0_droid is pi0 already post-trained on
# DROID, so it carries the joint-VELOCITY action prior the real datasets use, and
# it ships the DROID normalization statistics that fine-tuning reuses verbatim.
